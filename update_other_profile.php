...
if (!isset($_GET['user_id'])) {
    header("Location: other_users.php");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt->bind_param("ssssssi", $firstname, $lastname, $email, $phone, $contract, $position, $other_user_id);
    $stmt->execute();
    $stmt->close();
...
<body>
    ...
    <form action="update_other_profile.php?user_id=<?php echo $other_user_id; ?>" method="post">
