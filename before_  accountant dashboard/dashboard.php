...
// Fetch user requests
$query = "SELECT rqst_id, rqst_time, rqst_title, status FROM request WHERE rqst_by = ? ORDER BY rqst_time DESC";
    ...
    <div class="container">
        ...
        <?php if ($is_approver): ?>
            <div class="approver-btn">
                <button onclick="location.href='admins_dashboard.php'">Check New Requests</button>
            </div>
        <?php endif; ?>
